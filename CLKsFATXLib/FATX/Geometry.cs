...
namespace CLKsFATXLib.Geometry
{
    ...
    {
        Magic = 0x0,
        PublicKeyCertSize = 0x6,
        CertificateOwnerConsoleID = 0x6,
        CertificateOwnerConsolePartNumber = 0xB,
        CertificateOwnerConsoleType = 0x1F,
        CertificateDateofGeneration = 0x20,
        PublicExponent = 0x28,
        PublicModulus = 0x2C,
        CertificateSignature = 0xAC,
        Signature = 0x1AC,
        LicenceEntries = 0x22C,
        HeaderSHA1Hash = 0x32C,
        HeaderSize = 0x340,
        ContentType = 0x344,
        MetadataVersion = 0x348,
        ContentSize = 0x34C,
        MediaID = 0x354,
        Version = 0x358,
        BaseVersion = 0x35C,
        ...
        ConsoleID = 0x36C,
        ProfileID = 0x371,
        FSVolumeDescriptor = 0x379,
        DataFileCount = 0x39D,
        DataFileCombinesSize = 0x3A1,
        DeviceID = 0x3FD,
        DisplayName = 0x411,
        DisplayDescription = 0xD11,
        PublisherName = 0x1611,
        TitleName = 0x1691,
        TransferFlags = 0x1711,
        ThumbnailImageSize = 0x1712,
        TitleThumbnailImageSize = 0x1716,
        ContentImage = 0x171A,
