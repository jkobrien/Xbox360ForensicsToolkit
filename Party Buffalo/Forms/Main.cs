...
namespace Party_Buffalo
{
    public partial class Main : Form
    {
        ...
        public bool ByPassDialog = false;
        ...
        {
            SaveFileDialog sfd = new SaveFileDialog();
            myFileName = Drive.FilePath.ToString();
            mySplit = myFileName.LastIndexOf("\\");
            myFilePath = myFileName.Substring(0, mySplit);
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "Security Sector " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
        ...
        private void m_ExtractJosh_Click(object sender, EventArgs e)
        {
            ...
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "Josh " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
        ...
        */
        ...
        {
            Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive);
            ea.ViewJoshSector();
        ...
        */
        private void menuItem16_Click_1(object sender, EventArgs e)
        {
            ...
            Forms.FileDetailsForm myFileDetailsForm = new Forms.FileDetailsForm(ea.SecuritySector.ToString());
            myFileDetailsForm.Show();
        }
        /**
        *   Title:          Xbox 360 Forensic Toolkit.
        ...
        *   Note:           All Code that follows to the End point was added by obriej62@mail.dcu.ie
        */
        private void ExtractSysExt2Click(object sender, EventArgs e)
        {
            SaveFileDialog sfd = new SaveFileDialog();
            myFileName = Drive.FilePath.ToString();
            mySplit = myFileName.LastIndexOf("\\");
            ...
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "SysExt2 " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
                Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive, Party_Buffalo.Forms.EntryAction.Method.ExtractSysExt2, sfd.FileName);
                ea.ShowDialog();
            }
            else if (sfd.ShowDialog() == DialogResult.OK)
            {
        ...
        *   Note:           All Code that follows to the End point was added by obriej62@mail.dcu.ie
        */
        private void ExtractSystemCacheClick(object sender, EventArgs e)
        {
            SaveFileDialog sfd = new SaveFileDialog();
            myFileName = Drive.FilePath.ToString();
            mySplit = myFileName.LastIndexOf("\\");
            ...
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "System Cache " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
                Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive, Party_Buffalo.Forms.EntryAction.Method.ExtractSystemCache, sfd.FileName);
                ea.ShowDialog();
            }
            else if (sfd.ShowDialog() == DialogResult.OK)
            {
        ...
        *   Note:           All Code that follows to the End point was added by obriej62@mail.dcu.ie
        */
        private void ExtractGameCacheClick(object sender, EventArgs e)
        {
            SaveFileDialog sfd = new SaveFileDialog();
            myFileName = Drive.FilePath.ToString();
            mySplit = myFileName.LastIndexOf("\\");
            ...
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "Game Cache " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
                Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive, Party_Buffalo.Forms.EntryAction.Method.ExtractGameCache, sfd.FileName);
                ea.ShowDialog();
            }
            else if (sfd.ShowDialog() == DialogResult.OK)
            {
        ...
        *   Note:           All Code that follows to the End point was added by obriej62@mail.dcu.ie
        */
        private void ExtractSysExtClick(object sender, EventArgs e)
        {
            SaveFileDialog sfd = new SaveFileDialog();
            myFileName = Drive.FilePath.ToString();
            mySplit = myFileName.LastIndexOf("\\");
            ...
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "SysExt Cache " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
                Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive, Party_Buffalo.Forms.EntryAction.Method.ExtractSysExt, sfd.FileName);
                ea.ShowDialog();
            }
            else if (sfd.ShowDialog() == DialogResult.OK)
            {
        ...
        *   Note:           All Code that follows to the End point was added by obriej62@mail.dcu.ie
        */
        private void ExtractXbox1Click(object sender, EventArgs e)
        {
            SaveFileDialog sfd = new SaveFileDialog();
            myFileName = Drive.FilePath.ToString();
            mySplit = myFileName.LastIndexOf("\\");
            ...
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "Xbox 1 " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
                Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive, Party_Buffalo.Forms.EntryAction.Method.ExtractXbox, sfd.FileName);
                ea.ShowDialog();
            }
            else if (sfd.ShowDialog() == DialogResult.OK)
            {
        ...
        *   Note:           All Code that follows to the End point was added by obriej62@mail.dcu.ie
        */
        private void ExtractDataClick(object sender, EventArgs e)
        {
            SaveFileDialog sfd = new SaveFileDialog();
            myFileName = Drive.FilePath.ToString();
            mySplit = myFileName.LastIndexOf("\\");
            ...
            myFileName = myFileName.Substring(mySplit + 1);
            sfd.Filter = "Backup File(*.bin)|*.bin";
            sfd.FileName = "Data " + myFileName + ".bin";
            if (ByPassDialog == true)
            {
                sfd.FileName = myFilePath + "\\" + sfd.FileName;
                Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive, Party_Buffalo.Forms.EntryAction.Method.ExtractData, sfd.FileName);
                ea.ShowDialog();
            }
            else if (sfd.ShowDialog() == DialogResult.OK)
            {
        ...
        *   Note:           All Code that follows to the End point was added by obriej62@mail.dcu.ie
        */
        private void ExtractAllClick(object sender, EventArgs e)
        {
            ByPassDialog = true;
            m_ExtractSecuritySector_Click(sender, e);
            m_ExtractJosh_Click(sender, e);
            ExtractSystemCacheClick(sender, e);
            ExtractGameCacheClick(sender, e);
            ExtractSysExtClick(sender, e);
            ExtractSysExt2Click(sender, e);
            ExtractXbox1Click(sender, e);
            ExtractDataClick(sender, e);
            ByPassDialog = false;
        }
        /**
        *   Title:          Xbox 360 Forensic Toolkit.
        ...
        */
        ...
        {
            Forms.ForensicReport sf = new Party_Buffalo.Forms.ForensicReport(Drive.Partitions,Drive);
            if (sf.ShowDialog() == DialogResult.OK)
            {
                //pathBar.Text = sf.Path;
                //goButton.PerformClick();
        ...
        */
        private void menuItem56_Click(object sender, EventArgs e)
        {
            Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(Drive);
            ea.ViewDriveInfo();
            Forms.FileDetailsForm myFileDetailsForm = new Forms.FileDetailsForm(ea.myDriveInfo.ToString());
            myFileDetailsForm.Show();
        }
        /**
        *   Title:          Xbox 360 Forensic Toolkit.
        ...
        */
        private void menuItem59_Click(object sender, EventArgs e)
        {
            ...
            {
                Forms.EntryAction ea = new Party_Buffalo.Forms.EntryAction(openFileDialog.FileName);
                ea.ViewSTFSFileStream();
                Forms.FileDetailsForm myFileDetailsForm = new Forms.FileDetailsForm(ea.mySTFSFile.ToString(), ea.SFTSFileName.ToString());
                myFileDetailsForm.Show();
            }
        }
